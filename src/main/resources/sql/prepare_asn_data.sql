BEGIN
    ...
    FROM (
        SELECT DISTINCT
            ...
            NULL AS UserDef4,
            NULL AS UserDef5
        FROM ZEN_MTL_TXN_REQUEST_HEADERS@PROD2 ZMTH, 
             ZEN_MTL_TXN_REQUEST_LINES@PROD2 ZMTL,
             MTL_MATERIAL_TRANSACTIONS@PROD2 MMT,
             MTL_ITEM_LOCATIONS@PROD2 MIL,
             MTL_ITEM_LOCATIONS@PROD2 MIL1
    ...
    FROM (
        SELECT 
            ...
            NVL(NVL(ZMTL.VENDOR_MATERIAL_INFO,ZEN_GET_WMS_ITEM_F(MSI.SEGMENT1)),MSI.SEGMENT1) AS lot_attr02
        FROM ZEN_MTL_TXN_REQUEST_HEADERS@PROD2 ZMTH, 
             ZEN_MTL_TXN_REQUEST_LINES@PROD2 ZMTL,
             MTL_MATERIAL_TRANSACTIONS@PROD2 MMT,
             MTL_ITEM_LOCATIONS@PROD2 MIL,

...
FROM (
         ...
         SELECT DISTINCT
             ...
             NULL AS UserDef5
         FROM
             OE_ORDER_HEADERS_ALL@ZENPROD OH,
             OE_ORDER_LINES_ALL@ZENPROD OL,
             OE_TRANSACTION_TYPES_TL@ZENPROD OTTL,
             OE_TRANSACTION_TYPES_ALL@ZENPROD OTTA,
...
FROM (
         ...
         SELECT
             ...
             NVL(NVL(ol.ATTRIBUTE16, ZEN_GET_WMS_ITEM_F(MSI.SEGMENT1,MSI.ORGANIZATION_ID)), MSI.SEGMENT1) AS lot_attr02
         FROM
             OE_ORDER_HEADERS_ALL@ZENPROD OH,
             OE_ORDER_LINES_ALL@ZENPROD OL,
             OE_TRANSACTION_TYPES_TL@ZENPROD OTTL,

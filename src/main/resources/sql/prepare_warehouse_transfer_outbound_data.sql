        ...
        SELECT
            ...
            CASE    
                WHEN ZMTH.HEADER_ID IS NULL
                    ...
                    OR NVL(ZMTL.ITEM_COST,0) IS NULL
                    OR ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@PROD2(ZMTL.TRANSACTIONAL_CURR_CODE)) IS NULL
            ...
            ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@PROD2(ZMTL.TRANSACTIONAL_CURR_CODE)) AS AMOUNT,
            '' AS CUST_PO,
            '' AS CUST_PO2,
            '' AS CUST_POLINE,
            '' AS CUST_PN,
        ...
        SELECT
            ...
            CASE    
                WHEN ZMTH.HEADER_ID IS NULL
                    ...
                    OR ZMTL.QUANTITY IS NULL
                    OR NVL(ZMTL.ITEM_COST,0) IS NULL
                    OR ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@jy(ZMTL.TRANSACTIONAL_CURR_CODE)) IS NULL
                    OR MSIB.ATTRIBUTE1 IS NULL
                    OR ZMTL.FROM_SUBINVENTORY_CODE IS NULL
                    OR mil.segment1 IS NULL
                    OR mil.segment2 IS NULL
            ...
            ZMTL.QUANTITY AS QUANTITY,
            TO_CHAR(NVL(ZMTL.ITEM_COST,0), 'FM9999999999999990.99999999999999999999') AS UNIT_PRICE,
            ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@jy(ZMTL.TRANSACTIONAL_CURR_CODE)) AS AMOUNT,
            '' AS CUST_PO,
            '' AS CUST_PO2,
            '' AS CUST_POLINE,
            '' AS CUST_PN,
        ...
        SELECT
            ...
            CASE    
                WHEN ZMTH.HEADER_ID IS NULL
                    ...
                    OR ZMTL.QUANTITY IS NULL
                    OR NVL(ZMTL.ITEM_COST,0) IS NULL
                    OR ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@SHCTRADING0(ZMTL.TRANSACTIONAL_CURR_CODE)) IS NULL
                    OR MSIB.ATTRIBUTE1 IS NULL
                    OR ZMTL.FROM_SUBINVENTORY_CODE IS NULL
                    OR mil.segment1 IS NULL
                    OR mil.segment2 IS NULL
            ...
            ZMTL.QUANTITY AS QUANTITY,
            TO_CHAR(NVL(ZMTL.ITEM_COST,0), 'FM9999999999999990.99999999999999999999') AS UNIT_PRICE,
            ROUND(NVL(ZMTL.ITEM_COST,0) * ZMTL.QUANTITY, ZEN_CURRENCY_PRECISION@SHCTRADING0(ZMTL.TRANSACTIONAL_CURR_CODE)) AS AMOUNT,
            '' AS CUST_PO,
            '' AS CUST_PO2,
            '' AS CUST_POLINE,
            '' AS CUST_PN,
